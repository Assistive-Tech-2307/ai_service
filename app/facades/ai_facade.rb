class AiFacade
  ...
  def create_message(params)
    ...
    "Please provide a cross-platform list of #{tech_needs} for people who #{disability_description}. Please provide a definition of each tool and a website for further exploration. Format your response as a JSON object, with each tech and it's information being a separate nested object in the technologies array like so {'technologies'=>[{'name'=>'tool_name', 'definition'=>'tool_definition', 'website'=>'tool_website'}]}"
  end
